  ...
  return (
    <ThemedView style={styles.stepContainer}>
      ...
      <View style={{ gap: 2 }}>
        ...
        <ThemedText>
          Supply: <ThemedText type="defaultSemiBold">{supplyQuery.data?.toString()}</ThemedText>{' '}
        </ThemedText>
      </View>
    </ThemedView>
  )
          ...
          return (
            <ThemedView key={`${event.transactionHash}${i}`} style={{ gap: 4 }}>
              <ThemedText>
                ...
                <ThemedText type="defaultSemiBold">{toTokens(event.args.value, 6)} USDC</ThemedText>{' '}
              </ThemedText>
            </ThemedView>
          )
        })}
